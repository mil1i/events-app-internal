...
//        e.g https://github.com/mil1i/events-app-internal might become https://github.com/MyName/external.git
// variables:
...
//      https://github.com/mil1i/events-app-internal.git
//      mil1i
//      internal
//      cluster-1 
    ...
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/mil1i/events-app-internal.git'
